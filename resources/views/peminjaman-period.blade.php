        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="/peminjaman-operator" class="d-none d-md-inline-block btn btn-md btn-primary shadow-md">Kembali</a>
                        &nbsp;
                        ...
                        <div class="dropdown-menu dropdown-menu-white" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="/peminjaman/pdf/{{$tgl_awal}}/{{$tgl_akhir}}" data-tgl_awal={{$tgl_awal}} data-tgl_akhir={{$tgl_akhir}}><i class="fas fa-file-pdf fa-fw mr-2 text-gray-400"></i>PDF</a>
                            <a class="dropdown-item" href="/peminjaman/excel/{{$tgl_awal}}/{{$tgl_akhir}}"><i class="fas fa-file-excel fa-md fa-fw mr-2 text-gray-400"></i>Excel</a>
                        </div>
                        </div>
                </div>  
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody class="text-center">
                                    @foreach ($data_loanItem as $data)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{$data->loan_request->item->add_item->name}}</td>
                                        <td>{{ $data->loan_request->item->add_item->brand }}</td>
                                        <td>{{ $data->loan_request->item->add_item->quantity }}</td>
                                        <td>{{$data->loan_request->loan_date}}</td>
                                        <td>{{$data->loan_request->max_return_date}}</td>
                                        <td>{{$data->return_date}}</td>
                                        <td>{{$data->loan_request->note}}</td>
                                        <td>{{$data->loan_request->path_file_cdn}}</td>
                                        @if($data->status == "done late")
