            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <h1>Barang yang dapat dipinjam:</h1>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                <thead class="text-center">
                                    <tr>
                                ...
                                <tbody class="text-center">
                                    @foreach($available_items as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->condition }}</td>
                                            <td>
                                                @if($queried_items->contains('id', $item->id))
                                                    <button disabled name="submit" type="submit" class="btn btn-secondary">
                                                        <i class="fas fa-plus-circle fa-sm text-white-50"></i> Sedang ditambah...
                                                    </button>
                                                @else
                                                    <form action="/peminjaman-3-add" method="post" enctype="multipart/form-data">
                                                        @csrf
